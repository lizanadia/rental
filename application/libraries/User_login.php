...
class User_login
{
    ...
    public function login($email, $password)
    {
        ...
        if ($cek) {
            ...
            if ($status_user == 0) {
                $this->ci->session->set_flashdata('error', '<p>' . $cek->nama_user . ' Akun Anda Sedang Kami Tahan..<br>Karna Melanggar Kode Etik.<br><br> <a href="https://api.whatsapp.com/send?phone=6281388189796&text=Hallo%20Kenapa%20Akun%20Saya%20Di%20Tahan%20Ya??" target="_blank" class="btn btn-success btn-md"><i class="bi bi-whatsapp"></i> Silahkan Hubungi Admin..</a></p>');
                redirect('auth/login');
            }
