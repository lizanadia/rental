                                ...
                                foreach ($pelanggan as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-warning btn-sm text-white" style="font-family: sans serif;" data-bs-toggle="modal" data-bs-target="#edit<?= $value->id_pelanggan ?>"><i class="fas fa-trash"></i>Edit</button>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white" style="font-family: Nunito;">Edit <?= $title ?></h5>
