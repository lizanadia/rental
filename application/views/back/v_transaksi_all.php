                            ...
                            <tbody>
                                <?php if ($alltransaksi == true) { ?>
                                    ...
                                    foreach ($alltransaksi as $key => $value) { ?>
                                        <tr class="text-center">
                                            ...
                                            <td style="vertical-align: middle;"><?= $value->nama_kendaraan ?></td>
                                            ...
                                            <?php if ($value->bukti_pembayaran == true) { ?>
                                                <td style="vertical-align: middle;">
                                                    <a href="<?= base_url('front/pelanggan/bukti-pembayaran/' . $value->bukti_pembayaran) ?>" data-gallery="portfolioGallery" class="portfokio-lightbox" title="<?= $value->nama_kendaraan ?>" target="_blank"><img src="<?= base_url('front/pelanggan/bukti-pembayaran/' . $value->bukti_pembayaran) ?>" class="img-fluid" width="100px" height="100px" alt=""></a>
                                                </td>
                                            <?php } else { ?>
                                ...
                                <?php } else { ?>
                                    <div class="alert alert-success alert-massage">
                                        ...
                                        <h4>Anda Belum Ada Pesanan, Silahkan Pesan Kendaraan Anda ...</h4>
                                    </div>
                                <?php } ?>
                            </tbody>
                        </table>
        ...
        <div class="modal fade bd-example-modal-lg" id="detail<?= $value->id_transaksi ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #A5E887; color: white; text-shadow: black;">
                        <h4>Detail transaksi <?= $value->nama_kendaraan ?></h4>
                    </div>
    ...
    <?php foreach ($alltransaksi as $key => $value) { ?>
        <div class="modal fade" id="edit<?= $value->id_transaksi ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="background-color: #A5E887; color: white;">
