        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-8 position-relative">
                    <label for="validationTooltipUsername" class="form-label">Masukkan Pasword Anda</label>
                ...
                <div class="col-md-8 position-relative">
                    <label for="validationTooltipUsername" class="form-label">Konfirmasi Password  Anda</label>
                    <div class="input-group has-validation">
                        <span class="input-group-text bg-primary text-white" id="validationTooltipUsernamePrepend"><i class="bi bi-key"></i></span>
                ...
                <div class="modal-footer">
                    <button type="submit" style="font-family:sans serif;" class="btn btn-primary">Hapus Akun</button>
                </div>
                <?php echo form_close(); ?>
