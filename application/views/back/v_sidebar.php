        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-user" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-universal-access"></i><span>Pengguna</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-user" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?= base_url('user/gantipassword') ?>">
                            <i class="bi bi-circle"></i><span>Hapus Akun</span>
                        </a>
                    </li>
                    <?php if ($this->session->userdata('level_user') == 1) { ?>
                        <li>
                            <a href="<?= base_url('user/userDataAll') ?>">
                                <i class="bi bi-circle"></i><span>All Data Pengguna</span>
                            </a>
                        </li>
                    <?php } ?>
                </ul>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-sepeda" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-car-front-fill"></i><span>Sepeda</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-sepeda" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="<?= base_url('sepeda/typesepeda') ?>">
                            <i class="bi bi-circle"></i><span>Type Sepeda</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('sepeda/typemerek') ?>">
                            <i class="bi bi-circle"></i><span>Merek Sepeda</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('sepeda/allsepeda') ?>">
                            <i class="bi bi-circle"></i><span>Data Sepeda</span>
                        </a>
                    </li>
                    <!-- <?php if ($this->session->userdata('level_user') == 1) { ?>
                        <li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-trx" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-cash-coin"></i><span>Penyewaan</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
