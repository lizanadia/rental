            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body my-3">
                        ...
                        <button type="button" class="btn2 my-2" style="font-family: Nunito;" data-bs-toggle="modal" data-bs-target="#tambah"><i class="fas fa-trash"></i>Tambah User</button>
                        <table class="table table-bordered table-responsive" id="example1">
                            <thead class="text-center" style="color: white; background-color: #A5E887;">
                                <tr>
                                    <th>No</th>
                                    <th>Nama User</th>
                                    <th>Email User</th>
                                ...
                                foreach ($userall as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-warning btn-sm text-white" style="font-family: cursive;" data-bs-toggle="modal" data-bs-target="#edit<?= $value->id_user ?>"><i class="fas fa-trash"></i>Edit</button>
                                            <a href="<?= base_url('user/hapus/' . $value->id_user) ?>" class="btn btn-danger btn-sm text-white" onclick="alert('Apakah Anda Yakin Ingin menghapus Data ini ?')" style="font-family: cursive;"><i class="fas fa-trash"></i>Hapus</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
    ...
    <div class="modal fade" id="tambah" tabindex="-1" data-bs-backdrop="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="color: white; background-color: #00AA95;">
                    <h5 class="modal-title text-white" style="font-family: sans serif;">Tambah <?= $title ?></h5>
                ...
                <div class="modal-footer">
                    <button type="button" style="font-family: sans serif;" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                    <button type="submit" style="font-family: sans serif;" class="btn2">Tambah</button>
                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white" style="font-family: cursive;">Edit <?= $title ?></h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" style="font-family: cursive;" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" style="font-family: cursive;" class="btn btn-primary">Edit</button>
                    </div>
