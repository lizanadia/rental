<main id="main" class="main">
    ...
    <div class="col-md-8">
        <button type="button" class="btn2 my-3" data-toggle="modal" data-target="#tambah">
        ...
        <div class="table-responsive-sm">
            <table class="table table-bordered table-responsive">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    foreach ($type_sepeda as $key => $value) { ?>
                        <tr>
                            <th><?= $no++ ?></th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open('sepeda/tambah') ?>
        ...
        <div class="modal fade" id="ubah<?= $value->id_type ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo form_open('sepeda/ubah/' . $value->id_type) ?>
                        <div class="input-group mb-3">
                    ...
                    <div class="modal-footer">
                        <button type="submit" style="font-family: Sans serif;" class="btn2 ">Ubah</button>
                    </div>
                    <?php echo form_close() ?>
                </div>
            </div>
        ...
        <div class="modal fade" id="hapus<?= $value->id_type ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <?php echo form_open('sepeda/hapus/' . $value->id_type) ?>
                    <div class="modal-body">
