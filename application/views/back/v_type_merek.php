<main id="main" class="main">
    ...
    <div class="col-md-8">
        <button type="button" class="btn2 my-3" data-toggle="modal" data-target="#tambahmerek">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo form_open_multipart('sepeda/tambahmerek') ?>
                ...
                <div class="modal-footer">
                    <button type="submit" style="font-family: Nunito;" class="btn2">Tambah</button>
                </div>
                <?php echo form_close() ?>
            </div>
        </div>
        ...
        <div class="modal fade" id="ubahmerek<?= $value->id_merek ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <?php echo form_open_multipart('sepeda/ubahmerek/' . $value->id_merek) ?>
                        <div class="input-group mb-3">
                    ...
                    <div class="modal-footer">
                        <button type="submit" style="font-family: sans serif;" class="btn btn-primary">Ubah</button>
                    </div>
                    <?php echo form_close() ?>
                </div>
            </div>
        ...
        <div class="modal fade" id="hapusmerek<?= $value->id_merek ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <?php echo form_open('sepeda/hapusmerek/' . $value->id_merek) ?>
                    <div class="modal-body">
