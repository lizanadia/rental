...
<head>
    ...
    <link href="<?= base_url() ?>back/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="<?= base_url() ?>front/img-sepeda/logo2.png" alt="">
                <span class="d-none d-lg-block" style="font-family: sans-serif;">RENT.BIKE</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2" style="font-family: sans serif;"><?= $this->session->userdata('nama_user') ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            ...
                            <h6 style="font-family: sans serif;"><?= $this->session->userdata('nama_user') ?></h6>
                            <span style="font-family: sans serif;">Login Sebagai : <?php if ($this->session->userdata('level_user') == 1) {
