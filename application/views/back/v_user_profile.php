                    ...
                    <div class="row g-0">
                        <div class="col-md-4">
                            ...
                            <div class="card-footer my-1">
                                <p style="font-family: Nunito;"><b><?= $this->session->userdata('nama_user') ?></b></p>
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title" style="font-family: Nunito;"><?= $this->session->userdata('email') ?></h5>
                                <p class="card-text" style="font-family: Nunito;">Status Anda : <?php if ($this->session->userdata('status_user') == 0) {
                                                                                                        echo '<span class="badge bg-danger">Tidak Aktif</span>';
                                                                                                    } else {
                                                                                                        echo '<span class="badge bg-primary">Aktif</span>';
                                                                                                    } ?></p>
                                <p class="card-text" style="font-family: Nunito;">Level Anda : <?php if ($this->session->userdata('level_user') == 1) {
                                ...
                                <div class="d-grid gap-2 mt-3">
                                    <button type="button" class="btn2" style="font-family: Nunito;" data-bs-toggle="modal" data-bs-target="#disablebackdrop">
                                        Edit Profile
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="color: white; background-color: #00AA95;">
                    <h5 class="modal-title text-white" style="font-family: sans serif;">Edit <?= $title ?></h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" style="font-family: sans serif;" class="btn btn-primary">Edit</button>
                </div>
