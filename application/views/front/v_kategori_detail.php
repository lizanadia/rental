            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 entries">
                        <div class="row">
                            <?php foreach ($sepeda_kategori as $key => $value) { ?>
                                <div class="col-4">
                                    <div class="card-group">
                                        <div class="card">
                                            <img class="card-img-top" src="<?= base_url('back/uploads/' . $value->gambar) ?>" width="170px" height="150px" alt="Card image cap">
                                            <div class="card-body">
                                                <h4 class="card-title"><?= $value->nama_kendaraan ?></h4>
                                                <p class="card-text">Tahun Kendaraan : <?= $value->tahun ?></p>
                                                <p class="card-text">Nomor Plat : <?= $value->no_plat ?></p>
                                                <p class="card-text">Warna Sepeda : <?= $value->warna ?></p>
                            ...
                            <div class="card-body">
                                <div class="pt-4 pb-2">
                                    <div class="text-center my-3">
                                        <img src="<?= base_url() ?>front/img-mobil/icon.png" style="width: 150px; height: 100;">
                                    </div>
